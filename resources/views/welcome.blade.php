    ...
    <div class="container"><a class="navbar-brand">Solution</a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="{{route('login')}}" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase">login</a> <a href="{{route('register')}}"
        ...
        <div class="row">
            <div class="col-md-6">
                <h1> We promise to bring
                    the best <span>Loan Solution</span> for
                    your business. </h1>
                <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. In rhoncus turpis nisl. </p>
                <a href="/apply-loan">Apply for a Loan <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Auto Loan</h3>
                    ...
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Unsecured Loan</h3>
                                <p class="card-text">Nullam quis libero in lorem accumsan sodales. Nam vel nisi
                                    eget.</p>
                            </div>
                        </div>
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">24hr Loan</h3>
                                <p class="card-text">Nullam quis libero in lorem accumsan sodales. Nam vel nisi
                                    eget.</p>
                            </div>
                        </div>
